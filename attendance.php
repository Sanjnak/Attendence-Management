...
<main class="w-screen sm:w-2/3 md:w-4/5 pt-1 px-2 bg-gray-300">
            <!-- content area -->
            <div class="flex items-center justify-between">
<form action = "attendencemark.php" method="POST">            
...
<td class="px-40 py-4">
<input type="checkbox" id="present" name="attend[]" value='<?php echo $row['ID'] ?>'>&nbsp;Present
</td>
<?php
          }
      }
...
<div class="flex items-center justify-between">
      <input type="submit" value="Submit" class="bg-blue-600 hover:bg-cyan-700 text-white font-bold py-2 px-6  ml-1 mt-8 rounded focus:outline-none focus:shadow-outline" >
    </div>
    </form>
</main>
</div>
