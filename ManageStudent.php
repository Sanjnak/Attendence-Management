...
<a href="EditStudentForm.php?id=<?php echo $row['ID'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
</td>
<td class="px-4 py-4 text-right">
<a href="DeleteStudentRecord.php?id=<?php echo $row['ID'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</a>
</td>
<?php
          }
      }
